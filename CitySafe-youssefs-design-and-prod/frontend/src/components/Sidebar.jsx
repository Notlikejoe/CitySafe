...
import {
  ...
  Settings, PanelLeftClose, PanelLeftOpen, Search, LogOut, Users,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/community", label: "Community", Icon: Users, desc: "Active SOS & hazards" },
          ...
          <div className="p-3 space-y-2">
            ...
            <div className="flex items-center gap-3 px-2 py-2">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs font-semibold text-slate-700 truncate">{displayName}</div>
